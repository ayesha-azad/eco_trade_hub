...
while($row_data = mysqli_fetch_assoc($result_brands)){
  ...
  <div class="form-group">
    ...
    <div class="input-group has-validation">
      ...
      <img class="edit-img" src="../seller/product_images/<?php echo $product_image1 ?>" alt="">
      <div class="invalid-feedback">
  ...
  <div class="form-group">
    ...
    <div class="input-group has-validation">
      ...
      <img class="edit-img" src="../seller/product_images/<?php echo $product_image2 ?>" alt="">
      <div class="invalid-feedback">
  ...
  <div class="form-group">
    ...
    <div class="input-group has-validation">
      ...
      <img class="edit-img" src="../seller/product_images/<?php echo $product_image3 ?>" alt="">
      <div class="invalid-feedback">
...
if (isset($_POST['insert_product'])) {
    ...
    foreach ($image_names as $key => $image_name) {
        if (!empty($_FILES[$image_name]['name'])) {
            ...
            move_uploaded_file($_FILES[$image_name]['tmp_name'], "../seller/product_images/" . $uploaded_images[$key]);
        } else {

<h2 style="color: #0A1F44; font-weight: 800" class="text-center my-5">ALL PRODUCTS</h2>
    ...
    <div class="row">
        ...
        <thead>
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            $get_owner_id = "SELECT * FROM sellers WHERE seller_id = $seller_id";
            $result_owner = mysqli_query($conn, $get_owner_id);
            $row_owner = mysqli_fetch_assoc($result_owner);
            $product_owner = $row_owner['seller_email'];
            ?>
            <tr>
                <td><?php echo $number; ?></td>
                <td><?php echo $product_title; ?></td>
                <td><?php echo $product_owner; ?></td>
                <td><?php echo "<img class='product-img' src='../seller/product_images/$product_image1'>"; ?></td>

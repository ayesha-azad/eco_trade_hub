        ...
        <div class="col-lg-12 bg-light p-1 mt-5 d-flex justify-content-center">
            <div class="text-center p-3">
                <button class="border-0">
                    <a href="login.php?user_login" class="btn text-white btn-panel">User Login</a>
                </button>
                <button class="border-0">
                    <a href="login.php?seller_login" class="btn text-white btn-panel">Seller Login</a>
                </button>
                <button class="border-0">
                    <a href="login.php?admin_login" class="btn text-white btn-panel">Admin Login</a>
                </button>
            </div>
        </div>
    </div>

...
<body>
        ...
        <div class="container-fluid pt-1 pb-1">
            ...
            <ul class="navbar-nav mb-2 mb-lg-0 ms-auto">
                <?php if (!isset($_SESSION['username'])) { ?>
                    <li class="nav-item">
                        <a class="nav-link active btn btn-outline-success" href="login.php">Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active btn btn-outline-danger mx-2" href="registration.php">Register</a>
                    </li>
                <?php } else { ?>
                    <li class="nav-item">
                ...
                <?php } ?>
                <li class="nav-item">
                    <a class="nav-link active w-5" aria-current="page" href="cart.php">
                        <i class="fa-solid fa-cart-shopping me-1"></i>
                        <sup><?php cartItems() ?></sup>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active w-5" aria-current="page" href="#">
                        Total Amount: <?php totalCartPrice(); ?>/-
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                <div class="row row-cols-lg-2 row-cols-md-1 row-cols-1">
                    <?php viewDetails(); ?>
                    <?php getUniqueCategories(); ?>
                    <?php getUniqueBrands(); ?>
                </div> <!-- end of row -->
            </div> <!-- end of col-lg-10 -->
            
            <?php
            include("users/reviews.php");
            ?>
    ...
    <script src="users/ratingSystem.js"></script>
